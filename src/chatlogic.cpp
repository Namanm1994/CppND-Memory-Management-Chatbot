...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            (*parentNode)->AddEdgeToChildNode(std::move(std::make_unique<GraphEdge>(id)));
                        }
    ...
    // std::cout << "After SetRootNode, Before Move chatbot here" << std::endl;
...
void ChatLogic::SendMessageToUser(std::string message)
{
    ...
    // std::cout << "SendMessageToUser 1 : " << std::endl;
